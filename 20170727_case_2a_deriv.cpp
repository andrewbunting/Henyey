...
int main()
{
    ...
    ifstream infile;
    infile.open("Input/profiles_Henyey_sun.txt");
    ...
    ifstream linefile;
    linefile.open("Input/profiles_Henyey_sun.txt");
...
*/
    ...
    for (k=0; k < J-1; k=k+1) {
        ...
        /*
         ...
         Mr[0][0][0] = 2.0*(rmid_cm_HR[1]/R) + 9.0;
         Mr[0][1][0] = (rmid_cm_HR[1]/R) + 2.0;
         
         Mi[0][0][0] = 0;
         Mi[0][1][0] = 0;
         
         Nr[0][0][0] = 5.0*(radius_cm_HR[0]/R) + 5.0;
         Nr[0][1][0] = 8.0*(radius_cm_HR[0]/R) - 6.0;
         ...
         Mr[0][0][0] = 2.0*(rmid_cm_HR[1]/R) + 8.0*cos(rmid_cm_HR[1]/R) + cos(3.6*rmid_cm_HR[1]/R) + cosh(rmid_cm_HR[1]/R);
         Mr[0][1][0] = 2.0*(rmid_cm_HR[1]/R) + cos(rmid_cm_HR[1]/R) + 3.0*cos(3.6*rmid_cm_HR[1]/R) - 2.0*cosh(rmid_cm_HR[1]/R);
         
         Mi[0][0][0] = 0;
         Mi[0][1][0] = 0;
         
         Nr[0][0][0] = (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R) + 4.0*sin(radius_cm_HR[0]/R) + 3.6*sin(3.6*radius_cm_HR[0]/R) + 6.0*sinh(radius_cm_HR[0]/R);
         Nr[0][1][0] = (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R) + 7.0*sin(radius_cm_HR[0]/R) + 18.0*sin(3.6*radius_cm_HR[0]/R) - sinh(radius_cm_HR[0]/R);
         ...
         Mr[0][0][0] = (rmid_cm_HR[1]/R)*sin(rmid_cm_HR[1]/R) + 8.0*sqrt(rmid_cm_HR[1]/R)*sin(sqrt(200)*rmid_cm_HR[1]/R) + 50.0*sin(sqrt(17.0)*rmid_cm_HR[1]/R)/(sqrt(17.0)*rmid_cm_HR[1]/R) + cosh(rmid_cm_HR[1]/R) + 3.0*cos(sqrt(23.0)*rmid_cm_HR[1]/R);
         Mr[0][1][0] = (rmid_cm_HR[1]/R)*sin(rmid_cm_HR[1]/R) + sqrt(rmid_cm_HR[1]/R)*sin(sqrt(200)*rmid_cm_HR[1]/R) + 3.0*50.0*sin(sqrt(17.0)*rmid_cm_HR[1]/R)/(sqrt(17.0)*rmid_cm_HR[1]/R) - 2.0*cosh(rmid_cm_HR[1]/R) - 2.0*3.0*cos(sqrt(23.0)*rmid_cm_HR[1]/R);
         
         Mi[0][0][0] = 0;
         Mi[0][1][0] = 0;
         
         Nr[0][0][0] = (radius_cm_HR[0]/R)*sin(radius_cm_HR[0]/R) + 4.0*sqrt(radius_cm_HR[0]/R)*sin(sqrt(200)*radius_cm_HR[0]/R) - 50.0*sin(sqrt(17.0)*radius_cm_HR[0]/R)/(sqrt(17.0)*radius_cm_HR[0]/R) + 6.0*cosh(radius_cm_HR[0]/R) + 6.0*3.0*cos(sqrt(23.0)*radius_cm_HR[0]/R);
         Nr[0][1][0] = (radius_cm_HR[0]/R)*sin(radius_cm_HR[0]/R) + 7.0*sqrt(radius_cm_HR[0]/R)*sin(sqrt(200)*radius_cm_HR[0]/R) - 5.0*50.0*sin(sqrt(17.0)*radius_cm_HR[0]/R)/(sqrt(17.0)*radius_cm_HR[0]/R) - cosh(radius_cm_HR[0]/R) - 3.0*cos(sqrt(23.0)*radius_cm_HR[0]/R);
...
//        cout << 1/(radius_cm[k+1] - radius_cm[k]) << "\n";
        ...
        Ar[0][0][0] = -R/(radius_cm_HR[1] - radius_cm_HR[0]);
        Ar[0][0][1] = -8.0*R/(radius_cm_HR[1] - radius_cm_HR[0]);
        Ar[0][1][0] = -R/(radius_cm_HR[1] - radius_cm_HR[0]);
        Ar[0][1][1] = -R/(radius_cm_HR[1] - radius_cm_HR[0]);
        ...
        Cr[0][0][0] = R/(radius_cm_HR[1] - radius_cm_HR[0]);
        Cr[0][0][1] = 8.0*R/(radius_cm_HR[1] - radius_cm_HR[0]);
        Cr[0][1][0] = R/(radius_cm_HR[1] - radius_cm_HR[0]);
        Cr[0][1][1] = R/(radius_cm_HR[1] - radius_cm_HR[0]);
        ...
        Fr[0][0][0] = R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Fr[0][0][1] = -6.0*R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Fr[0][1][0] = 5.0*R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Fr[0][1][1] = R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        ...
        Hr[0][0][0] = -R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Hr[0][0][1] = 6.0*R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Hr[0][1][0] = -5.0*R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Hr[0][1][1] = -R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
...
//        cout << "\t Done the v_{" << k << "} and u_{" << k << "} loop \n";
    ...
    ofstream outfile;
    outfile.open("Output/20170727_2a_deriv.dat", ios::out);
