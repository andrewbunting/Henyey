...
*/
    ...
    for (k=0; k < J-1; k=k+1) {
        ...
        /*
         ...
         This approximation does break down a bit as you approach 1, but not as badly as when you get a pole at x=0, so that's why there's an IfElse statement - to transition from the Taylor expansion to the actual expression.
...
//        cout << "\t Done the v_{" << k << "} and u_{" << k << "} loop \n";
    ...
    ofstream outfile;
    outfile.open("Output/Henyey_test.dat", ios::out);
