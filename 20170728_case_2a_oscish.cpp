...
*/
    ...
    double R, m, l, f, G, mp, D, omega, Mstar, d_one, d_two, dp_dr_BC, dlnT_dr_BC,prop;
...
*/
    ...
    double radius_cm_HR_output[J],test[J];
    ...
    ofstream matrixfile;
    matrixfile.open("Output/Matrices.dat", ios::out);
    ...
    for (k=0; k < J-1; k=k+1) {
        ...
        if (k < U+E && k > 0) {
            ...
            // Here we define the array_HR values for the interpolation region
                    ...
                    // Redefine the variables here!! (e.g. F_{k,n})
        ...
        /*
         ...
         This is the simple, derivative-free case.
...
//        cout << 1/(radius_cm[k+1] - radius_cm[k]) << "\n";
        ...
        Ar[0][0][0] = -R*radius_cm_HR[0]*radius_cm_HR[0]/(rmid_cm_HR[1]*rmid_cm_HR[1]*(radius_cm_HR[1] - radius_cm_HR[0]));
        Ar[0][0][1] = 0.0;
        Ar[0][1][0] = 0.5;
        Ar[0][1][1] = -R*radius_cm_HR[0]*radius_cm_HR[0]/(rmid_cm_HR[1]*rmid_cm_HR[1]*(radius_cm_HR[1] - radius_cm_HR[0]));
        
        Ai[0][0][0] = 0;
        Ai[0][0][1] = 0;
        Ai[0][1][0] = 0; // -brunt_A_HR[1]*chiRho_HR[1]/( 2.0*chiT_HR[1] ); //- R * cp_HR[1] * brunt_A_HR[1] * chiRho_HR[1] / (2.0 * chiT_HR[1]);
        Ai[0][1][1] = 0;
        
        Cr[0][0][0] = R*radius_cm_HR[1]*radius_cm_HR[1]/(rmid_cm_HR[1]*rmid_cm_HR[1]*(radius_cm_HR[1] - radius_cm_HR[0]));
        Cr[0][0][1] = 0.0;
        Cr[0][1][0] = 0.5;
        Cr[0][1][1] = R*radius_cm_HR[1]*radius_cm_HR[1]/(rmid_cm_HR[1]*rmid_cm_HR[1]*(radius_cm_HR[1] - radius_cm_HR[0]));
        
        Ci[0][0][0] = 0;
        Ci[0][0][1] = 0;
        Ci[0][1][0] = 0; // -brunt_A_HR[1]*chiRho_HR[1]/( 2.0*chiT_HR[1] ); //- R * cp_HR[1] * brunt_A_HR[1] * chiRho_HR[1] / (2.0 * chiT_HR[1]);
        Ci[0][1][1] = 0;
        ...
        Di[0][0][0] = 0;
        Di[0][0][1] = 0;
        Di[0][1][0] = 0; // - grada_HR[1]; //-grada_HR[1];
        Di[0][1][1] = 0; // 1.0; //1.0;
        ...
        Fr[0][0][0] = delta[0];
        Fr[0][0][1] = delta[0] - R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Fr[0][1][0] = delta[0] - R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Fr[0][1][1] = delta[0];
        ...
        Hr[0][0][0] = delta[1];
        Hr[0][0][1] = delta[1] + R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Hr[0][1][0] = delta[1] + R/(rmid_cm_HR[1] - rmid_cm_HR[0]);
        Hr[0][1][1] = delta[1];
        ...
        Mr[0][0][0] = 3.0*sin(rmid_cm_HR[1]/R) + (rmid_cm_HR[1]/R)*cos(rmid_cm_HR[1]/R) + 50.0*sin(sqrt(17.0)*rmid_cm_HR[1]/R)/(sqrt(17.0)*rmid_cm_HR[1]/R) + cosh(rmid_cm_HR[1]/R) + 3.0*cos(sqrt(23.0)*rmid_cm_HR[1]/R);
        Mr[0][1][0] = (rmid_cm_HR[1]/R)*sin(rmid_cm_HR[1]/R) + 2.5*sin(sqrt(200)*(rmid_cm_HR[1]/R))/(sqrt(rmid_cm_HR[1]/R)) + sqrt(200*rmid_cm_HR[1]/R)*cos(sqrt(200)*rmid_cm_HR[1]/R) + 50.0*sin(sqrt(17.0)*rmid_cm_HR[1]/R)/(sqrt(17.0)*rmid_cm_HR[1]/R) - cosh(rmid_cm_HR[1]/R) - 3.0*cos(sqrt(23.0)*rmid_cm_HR[1]/R);
        ...
        if (radius_cm_HR[0]/R < 0.3) {
            ...
            Nr[0][0][0] = sqrt(radius_cm_HR[0]/R)*sin(sqrt(200)*radius_cm_HR[0]/R) + 50.0*sin(sqrt(17)*radius_cm_HR[0]/R)/(sqrt(17)*(radius_cm_HR[0]/R)) + cosh(radius_cm_HR[0]/R) + 3.0*cos(sqrt(23)*(radius_cm_HR[0]/R)) + sinh(radius_cm_HR[0]/R) - sqrt(207.0)*sin(sqrt(23.0)*radius_cm_HR[0]/R);
            Nr[0][1][0] = (radius_cm_HR[0]/R)*sin(radius_cm_HR[0]/R) + 50.0*sin(sqrt(17)*radius_cm_HR[0]/R)/(sqrt(17)*(radius_cm_HR[0]/R)) + cosh(radius_cm_HR[0]/R) + 3.0*cos(sqrt(23)*(radius_cm_HR[0]/R)) + (-(850 * (radius_cm_HR[0]/R))/3 + (1445 * (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R))/3 - (24565 * (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R))/84 + (417605 * (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R))/4536 - (7099285 * (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R))/399168 + (24137569 * (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)*(radius_cm_HR[0]/R))/10378368);
            
        } else {
            
            Nr[0][0][0] = sqrt(radius_cm_HR[0]/R)*sin(sqrt(200)*radius_cm_HR[0]/R) + 50.0*sin(sqrt(17)*radius_cm_HR[0]/R)/(sqrt(17)*(radius_cm_HR[0]/R)) + cosh(radius_cm_HR[0]/R) + 3.0*cos(sqrt(23)*(radius_cm_HR[0]/R)) + sinh(radius_cm_HR[0]/R) - sqrt(207.0)*sin(sqrt(23.0)*radius_cm_HR[0]/R);
            Nr[0][1][0] = (radius_cm_HR[0]/R)*sin(radius_cm_HR[0]/R) + 50.0*sin(sqrt(17)*radius_cm_HR[0]/R)/(sqrt(17)*(radius_cm_HR[0]/R)) + (50.0/sqrt(17))*( ((sqrt(17)*(radius_cm_HR[0]/R)*cos(sqrt(17)*radius_cm_HR[0]/R) - sin(sqrt(17)*radius_cm_HR[0]/R)))/((radius_cm_HR[0]/R)*(radius_cm_HR[0]/R)) ) + cosh(radius_cm_HR[0]/R) + 3.0*cos(sqrt(23)*(radius_cm_HR[0]/R));
...
/*    cout << "( BCc D - BCb nu + BCa Q H )^{-1} r \n";
  ...
  */
    ...
    for (k=J-2; k >= 0; k = k - 1) {
        ...
        ur[k][0][0] = dumVAr[0][0][0] + dumVBr[0][0][0] + RECcr[k][0][0];
        ur[k][1][0] = dumVAr[0][1][0] + dumVBr[0][1][0] + RECcr[k][1][0];

        ui[k][0][0] = dumVAi[0][0][0] + dumVBi[0][0][0] + RECci[k][0][0];
        ui[k][1][0] = dumVAi[0][1][0] + dumVBi[0][1][0] + RECci[k][1][0];
...
//        cout << "\t Done the v_{" << k << "} and u_{" << k << "} loop \n";
    ...
    ofstream outfile;
    outfile.open("Output/20170728_2a_oscish.dat", ios::out);
...
*/
        ...
        /* This writes the data to the file, in the order:
         ...
         19- test
         */
        outfile << radius_cm_HR_output[k]/R << "\t\t\t" << ur[k][0][0] << "\t\t" << ur[k][1][0] << "\t\t" << vr[k][0][0] << "\t\t" << vr[k][1][0] << "\t\t" << alphar[k][0][0] << "\t" << alphar[k][0][1] << "\t" << alphar[k][1][0] << "\t" << alphar[k][1][1] << "\t" << alphai[k][0][0] << "\t" << alphai[k][0][1] << "\t" << alphai[k][1][0] << "\t" << alphai[k][1][1] << "\t" << gammar[k][0][0] << "\t" << gammar[k][1][0] << "\t" << gammai[k][0][0] << "\t" << gammai[k][1][0] <<  "\t" << ur[k][0][0]*radius_cm_HR_output[k]*(1.0/100.0)*m*omega*((mp + Mstar)/(mp)) << "\t" << test[k] << "\n";
