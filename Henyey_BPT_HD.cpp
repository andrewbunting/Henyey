...
int main()
{
    ...
    ifstream infile;
    infile.open("Input/profiles_Henyey_conv_Ubuntu_1_0_alpha2H.txt");
    ...
    ifstream linefile;
    linefile.open("Input/profiles_Henyey_conv_Ubuntu_1_0_alpha2H.txt");
    ...
    double cv[J], gamma1[J], gamma3[J], conv_L_div_L[J], flux_tot[J];
    ...
    double K_HR[2], rho_face_HR[2], gamma1_HR[2], flux_tot_HR[2], conv_L_div_L_HR[2];
    ...
    double radius_cm_HR_output[J],rmid_cm_HR_output[J];//,test[J],Fprime_for_T[J],Fprime_for_p[J],flux_HR_output[J],pressure_HR_output[J],temperature_HR_output[J],rho_HR_output[J],eta_Terquem_output[J],grav_HR_output[J],rho_face_HR_output[J],opacity_HR_output[J],K_HR_output[J],chiRho_HR_output[J],chiT_HR_output[J],brunt_A_HR_output[J],cp_HR_output[J],grada_HR_output[J],conv_L_div_L_HR_output[J],flux_tot_HR_output[J];
    ...
    ofstream outfile;
    outfile.open("Output/Henyey_BPT_HD.dat", ios::out);
    ...
    double ddeltaP_dr_hydro_Jminus3_r, ddeltaP_dr_hydro_Jminus3_i, ddeltaP_dr_hydro_Jminus4_r, ddeltaP_dr_hydro_Jminus4_i, V_cont_r, V_cont_i, s_prime_r, s_prime_i, delta_s_r, delta_s_i, F_conv_prime_div_F_conv_r, F_conv_prime_div_F_conv_i;
    ...
    for (k=0; k<J; k=k+1) {
        ...
        */
        ...
        // 171 to 180
        outfile << conv_L_div_L_HR_output[k] << "\t\t" << flux_HR_output[k]/(1.0 - conv_L_div_L_HR_output[k]) << "\t\t" << flux_HR_output[k]*conv_L_div_L_HR_output[k]/(1.0 - conv_L_div_L_HR_output[k]) << "\t\t" << F_conv_prime_div_F_conv_r << "\t\t" << F_conv_prime_div_F_conv_i << "\t\t" << prefactor << "\n";
...
int FunctionF(double* xadd, double* f)
{
    ...
    *f = 0.000016 + 0.00036*x*x; //0.000002 + 0.004*x*x; //0.00006 + 0.00016*x*x; //0.01+0.03*x*x; //0.00005 + 0.00015*x*x;
...
int FunctionG(double* xadd, double* g)
{
    ...
    *g = 0.0000035; //0.0000001; //0.0000035; //(0.0001 + 0.00015*x*x)*( 1.0 - exp(-(x-0.4999)/0.3) ); // 0.000000027; //0.0000035;
...
int FunctionY(double* xadd, double* y)
{
    ...
    beta = 0.00015; //0.0005; //0.0000005; //0.0005;
