...
*/
    ...
    for (k=0; k < J-1; k=k+1) {
        ...
        /*
         ...
         Mr[0][0][0] = 11.0*rmid_cm_HR[1]/(R);
         Mr[0][1][0] = 3.0*rmid_cm_HR[1]/(R);
         
         Mi[0][0][0] = 0;
         Mi[0][1][0] = 0;
         
         Nr[0][0][0] = 10.0*radius_cm_HR[0]/(R);
         Nr[0][1][0] = 2.0*radius_cm_HR[0]/(R);
         ...
         Mr[0][0][0] = (rmid_cm_HR[1]/R)*(rmid_cm_HR[1]/R) + 8.0*sin(rmid_cm_HR[1]/R) + cos(3.6*rmid_cm_HR[1]/R) + cosh(rmid_cm_HR[1]/R);
         Mr[0][1][0] = (rmid_cm_HR[1]/R)*(rmid_cm_HR[1]/R) + sin(rmid_cm_HR[1]/R) + 3.0*cos(3.6*rmid_cm_HR[1]/R) - 2.0*cosh(rmid_cm_HR[1]/R);
         
         Mi[0][0][0] = 0;
         Mi[0][1][0] = 0;
         
         Nr[0][0][0] = (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R) + 4.0*sin(radius_cm_HR[0]/R) - cos(3.6*radius_cm_HR[0]/R) + 6.0*cosh(radius_cm_HR[0]/R);
         Nr[0][1][0] = (radius_cm_HR[0]/R)*(radius_cm_HR[0]/R) + 7.0*sin(radius_cm_HR[0]/R) - 5.0*cos(3.6*radius_cm_HR[0]/R) - cosh(radius_cm_HR[0]/R);
...
//        cout << 1/(radius_cm[k+1] - radius_cm[k]) << "\n";
        ...
        Fr[0][0][0] = -delta[0];
        Fr[0][0][1] = 6.0*delta[0];
        Fr[0][1][0] = -5.0*delta[0];
        Fr[0][1][1] = -delta[0];
        ...
        Hr[0][0][0] = -delta[1];
        Hr[0][0][1] = 6.0*delta[1];
        Hr[0][1][0] = -5.0*delta[1];
        Hr[0][1][1] = -delta[1];
...
//        cout << "\t Done the v_{" << k << "} and u_{" << k << "} loop \n";
    ...
    ofstream outfile;
    outfile.open("Output/20170727_2a.dat", ios::out);
